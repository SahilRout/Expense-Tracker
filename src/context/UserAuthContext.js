...
export function UserAuthContextProvider({ children }) {
  ...
  return (
    <userAuthContext.Provider
      value={{ user, logIn, signUp, logOut, googleSignIn, currentUser, total, setTransactionName, setTransacitonType, setPrice, addTransaction, transactions, deleteTransaction }}
    >
      {children}
    </userAuthContext.Provider>
  );
